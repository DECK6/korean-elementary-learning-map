...
Korean Elementary Learning Map(한국 초등 학습지도)은 **Marble Skill Taxonomy**가 보여 준 학습 그래프 접근에서 영감을 받아, 대한민국 2022 개정 초등 교육과정에 맞게 독립적으로 설계·구축한 Korea-first 학습 그래프다. 한국 교육과정 레코드, 교과 모델, 성취기준 매핑, 주제, 간선과 도구를 별도로 만들었으며 기존 영어권 분류체계의 번역본이나 Marble의 공식 파생 프로젝트가 아니다.
